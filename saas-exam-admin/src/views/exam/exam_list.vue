<template>
  <t-card :bordered="false">
    <t-button @click="createExam">创建试卷</t-button>
    <div class="mt-8">
      <DataTable :query="{
        where:{
          type:'exam'
        ...
        <template #operation="{ scope }">
          <t-button ariant="text" theme="primary" @click="findExam(scope.row._id)">查看试卷</t-button>
          &nbsp;
...
const findExam = (id: string) => {
  router.push(`/exam/create_exam/${id}`)
